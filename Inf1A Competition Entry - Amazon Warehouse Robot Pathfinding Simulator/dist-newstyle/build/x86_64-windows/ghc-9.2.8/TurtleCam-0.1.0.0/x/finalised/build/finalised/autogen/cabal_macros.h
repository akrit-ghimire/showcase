...
/* package TurtleCam-0.1.0.0 */
#ifndef VERSION_TurtleCam
#define VERSION_TurtleCam "0.1.0.0"
#endif /* VERSION_TurtleCam */
#ifndef MIN_VERSION_TurtleCam
#define MIN_VERSION_TurtleCam(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_TurtleCam */
...
#define CURRENT_COMPONENT_ID "TurtleCam-0.1.0.0-inplace-finalised"
